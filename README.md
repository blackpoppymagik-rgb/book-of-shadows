# Book of Shadows v7 · Botanical Restored + Full Tarot Deck

This static GitHub Pages package restores the full botanical visual direction and adds a full 78-card tarot system.

Upload these files to the root of your `book-of-shadows` repository:
- index.html
- README.md

## Includes
- Full botanical SVG frame
- Full 78-card tarot deck
- Original tarot study meanings, lessons, shadow checks, and journal prompts
- Visible reroll controls
- Save Today's Ritual
